...
import { HorizontalLayout, VerticalLayout, FlexibleLayout, combineLayouts, FixedLayout, GridLayout, HorizontalBox, VerticalBox, VBox, Grid } from './src/layout.js';
...
Grid({
    ...
    children: [
        ...
        div({children: 'cell 6'}),
        div({children: 'cell 7'}),
        VBox(span('cell 8-A'), span('cell 8-B')),
    ]
});
